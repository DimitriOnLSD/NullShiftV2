...
--               c:/GIT/NullShiftV2/NullShiftV2.gen/sources_1/bd/fdm/ip/fdm_reset_inv_0/fdm_reset_inv_0_stub.vhdl
...
entity fdm_reset_inv_0 is
  ...
  attribute CORE_GENERATION_INFO of fdm_reset_inv_0 : entity is "fdm_reset_inv_0,util_vector_logic_v2_0_5_util_vector_logic,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=util_vector_logic,x_ipVersion=2.0,x_ipCoreRevision=5,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_OPERATION=not,C_SIZE=1}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of fdm_reset_inv_0 : entity is "yes";
end fdm_reset_inv_0;

architecture stub of fdm_reset_inv_0 is
