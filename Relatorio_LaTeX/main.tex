...
\usepackage{listings}
\usepackage[dvipsnames,svgnames,x11names]{xcolor} % Para cores no código
 \usepackage{attachfile}
% ****************************************************************************************************
% Personal data and user ad-hoc commands
% ****************************************************************************************************
\newcommand{\myTitle}{Relatório Projeto Eletrónica Configurável - ASK, OOK\xspace}
\newcommand{\myDegree}{Mestrado em Eng.ª Eletrotécnica\xspace}
\newcommand{\myNameOne}{Pedro Ferreira\xspace}
\newcommand{\myNumber}{2022106868}
\newcommand{\myNameTwo}{Paulo Sousa\xspace}
\newcommand{\myNumberTwo}{2022102341}



\newcommand{\myFaculty}{Politécnico de Leiria\xspace}
\newcommand{\mySchool}{Escola Superior de Tecnologia e Gestão\xspace}
\newcommand{\myDepartment}{Departamento de Engenharia Eletrotécnica\xspace}
\newcommand{\myLocation}{Leiria\xspace}

\newcommand{\myTime}{Julho de 2026\xspace}
\newcommand{\mySchoolYear}{2025 -- 2025\xspace}
\newcommand{\myVersion}{versão 1.0\xspace}            
